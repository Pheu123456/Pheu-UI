        ...
        <div class = "card-wrapper">
          <div class = "card">
            ...
            <div class = "product-content">
              <h2 class = "product-title">Keycap nhân vật Hutao</h2>
              ...
              <div class = "product-price">
                <p class = "last-price">Giá cũ: <span>50.000.000 đ</span></p>
                <p class = "new-price">Giá mới: <span>34.000.000 đ(35%)</span></p>
              </div>
              ...
              <div class = "product-detail">
                ...
                <p>🛒 Hàng có sẵn
                    ...
                    💓Nếu bạn thích cửa hàng của chúng tôi, hãy quan tâm đến cửa hàng của chúng tôi để được giảm giá nhiều hơn trong tương lai! ! 💖
                    💌Nếu có thắc mắc vui lòng bấm "trò chuyện" chúng tôi sẽ sẵn lòng trợ giúp bạn
                    💖️️️⭐️️ Đánh giá năm sao của bạn là nguồn động viên và hỗ trợ lớn nhất của chúng tôi! Cảm ơn bạn đã đến!</p>
                <p>Lưu ý:</p>
                <p>🌈Mẫu mã: Genshin Impact Hu Tao Keycap</p>
                <p> 🌈Chất liệu: PBT            </p>
